...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "neorg", "nvim-treesitter-textobjects" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-tree.lua', 'nvim-autopairs', 'telescope.nvim', 'nvim-cmp', 'LuaSnip'}, { event = "VimEnter *" }, _G.packer_plugins)]]
