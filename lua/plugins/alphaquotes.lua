return {
    ...
    {"The art of doing mathematics consists in finding that special case which contains all the germs of the general problem.", "", "- David Hilbert"},
    ...
    {"When silence is prolonged, it takes on new meaning.", "", "- Yukio Mishima"},
